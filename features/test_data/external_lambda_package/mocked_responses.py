...
class Stub(CfnStub):
    def stack_id(self):
        return f"arn:aws:cloudformation:{self.region}:123456789012:stack/{self.stack_name()}/31b30580-87ad-11eb-8e6c-ccccc"
    ...
    def stack_name(self):
        return "cfnresponsechecker-external_lambda_package"
